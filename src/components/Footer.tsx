      ...
      <div className="footer-container container">
        <div className="footer-grid">
          ...
          <div className="footer-section categories">
            ...
            <ul>
              <li><a href="https://www.linkedin.com/company/umeafcnhub" target="_blank" rel="noopener noreferrer">LinkedIn Company Page</a></li>
          ...
          <div className="footer-section">
            ...
            <div className="footer-founder" style={{ marginTop: '12px' }}>
