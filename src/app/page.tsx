  ...
  return (
    ...
    <div className="home-page-with-sidebar">
      ...
      <div className="welcome-section">
        ...
        <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', fontSize: '0.95rem' }}>
          <span>Follow us on</span>
          <a href="https://www.linkedin.com/company/umeafcnhub" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#0077b5', fontWeight: '600', textDecoration: 'none' }}>
