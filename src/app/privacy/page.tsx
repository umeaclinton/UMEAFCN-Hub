    ...
    <article className="single-post">
      ...
      <div className="post-content">
        ...
        <ul>
          ...
          <li>Send you emails if you subscribe to newsletters or apply for jobs</li>
        ...
        <ul>
          <li>
            <strong>Google AdSense:</strong> You can read their Privacy Policy here: <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer">https://policies.google.com/technologies/ads</a>.
          </li>
        </ul>
        <p>
